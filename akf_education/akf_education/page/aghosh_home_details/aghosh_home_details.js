...
function renderHighcharts(data) {
	...
	probation_staff_count.innerHTML = data.probation_staff || 0;
	intern_staff_count.innerHTML = data.intern_staff || 0;
	single_sponsored_count.innerHTML = data.sponsorship_breakdown[0]['data'][0] || 0;
	double_sponsored_count.innerHTML = data.sponsorship_breakdown[0]['data'][1] || 0;
	triple_sponsored_count.innerHTML = data.sponsorship_breakdown[0]['data'][2] || 0;
	head_office_count.innerHTML = data.sponsorship_breakdown[0]['data'][3] || 0;
	local_sponsored_count.innerHTML = data.sponsorship_breakdown[0]['data'][4] || 0;
	regional_sponsored_count.innerHTML = data.sponsorship_breakdown[0]['data'][5] || 0;
